...
is being developed, see [OpenAds Server](http://github.com/prebid/prebid-server).
...
Additional documentation can be found at [OpenAds AMP](http://prebid.org/dev-docs/how-prebid-on-amp-works.html)
