...
const CREATIVE_BANNER_CSS_SELECTOR = 'iframe[id="google_ads_iframe_/92296675/prebid_multiformat_test_0"]';

const EXPECTED_TARGETING_KEYS = {
  oa_pb_adasta: '10.00',
  oa_format: 'native',
  oa_size: '0x0',
  oa_bidder_adasta: 'adasta',
  oa_pb: '10.00',
  oa_bidder: 'adasta',
  oa_format_adasta: 'native',
  oa_size_adasta: '0x0'
};
...
setupTest({
  ...
  it('should load the targeting keys with correct values', async function () {
    const result = await browser.execute(function () {
      return window.oajs.getAdserverTargeting('div-banner-native-2');
    });
