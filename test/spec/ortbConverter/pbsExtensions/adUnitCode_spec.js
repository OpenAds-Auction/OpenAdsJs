...
describe('pbjs -> ortb adunit code to imp[].ext.openads.adunitcode', () => {
  ...
  it('it sets adunitcode in ext.openads.adunitcode when adUnitCode is present', () => {
  ...
  it('does not set adunitcode in ext.openads.adunitcode if adUnit is undefined', () => {
