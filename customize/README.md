...
Use the webpack loader exported from `openads.js/customize/webpackLoader`.
...
Use the Rollup-compatible plugin exported from `openads.js/customize/rollupPlugin`.

```javascript
// rollup.config.js
import prebidBuildOptions from 'openads.js/customize/rollupPlugin'
...
If you need to integrate with another bundler, reuse the helper exported from `openads.js/customize/virtualBuildOptions`:
